...
var CSS =
'.cetDugme{position:fixed;right:10px;z-index:70;bottom:calc(var(--navh,52px) + env(safe-area-inset-bottom,0px) + 12px);' +
...
'.cetPanel{position:fixed;left:8px;right:8px;z-index:71;bottom:calc(var(--navh,52px) + env(safe-area-inset-bottom,0px) + 64px);' +
